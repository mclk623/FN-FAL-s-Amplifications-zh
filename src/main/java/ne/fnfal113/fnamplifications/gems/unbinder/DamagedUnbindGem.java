...
public class DamagedUnbindGem extends AbstractGemUnbinder {

    public DamagedUnbindGem(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        super(itemGroup, item, recipeType, recipe, 25);
    }
